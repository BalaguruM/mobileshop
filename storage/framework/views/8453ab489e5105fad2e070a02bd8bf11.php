<?php $__env->startSection('title', 'New Purchase from Dealer'); ?>
...
<form action="<?php echo e(route('dealer-transactions.store')); ?>" method="POST" id="purchaseForm">
    <?php echo csrf_field(); ?>
    <div class="row g-3">
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="<?php echo e($d->id); ?>" <?php echo e((request('dealer_id') == $d->id || old('dealer_id') == $d->id) ? 'selected' : ''); ?>>
                                <?php echo e($d->name); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-select" required>
                            <option value="purchase" <?php echo e(old('type')=='purchase'?'selected':''); ?>>Outright Purchase</option>
                            <option value="borrow" <?php echo e(old('type')=='borrow'?'selected':''); ?>>Borrowed / Credit</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="paid_amount" class="form-control" step="0.01" min="0" value="<?php echo e(old('paid_amount', 0)); ?>" required>
                    </div>
                    <div class="mb-3">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body p-2" id="itemsContainer">
                    <?php if($errors->any()): ?>
                        <?php $__currentLoopData = old('items', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item-row border border-primary rounded p-2 mb-2" id="row_<?php echo e($i); ?>">
                            <?php echo $__env->make('dealer-transactions._item_row', ['i' => $i, 'item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                    <div class="item-row border border-primary rounded p-2 mb-2" id="row_0">
                        <?php echo $__env->make('dealer-transactions._item_row', ['i' => 0, 'item' => []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php endif; ?>
                </div>
...
<script>
let rowCount = <?php echo e($errors->any() ? count(old('items', [[]])) : 1); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\balaguru.m\mobile\resources\views/dealer-transactions/create.blade.php ENDPATH**/ ?>